  ...
  <div class="card-form">
    ...
    <div class="card-form__inner">
      ...
      <div class="card-form__row">
        <div class="card-form__col">
          <div class="card-form__group">
            <label class="card-input__label">有効期限</label>
            <select
              :id="fields.cardMonth"
      ...
      <v-btn
        ...
        class="card-form__button msy-color-red"
        @click="submitForm"
      >
        登録する
      </v-btn>
...
export default {
  ...
  methods: {
    ...
    submitForm() {
      const cardInfo = Object.assign({}, this.formData);
      cardInfo.cardNumber = this.mainCardNumber;
      this.$emit("click-register", cardInfo);
    },
    blurCardNumber() {
