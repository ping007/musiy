<template>
  <div>
    <v-container class="artists-profile" :fluid="true">
      <v-row class="py-5">
        <UploadImageFile
      ...
      <v-form ref="form">
        ...
        <v-row class="py-5 mx-1">
          ...
          <v-btn
            rounded
            large
            class="ml-2 msy-color-red msy-color-text-white"
            :disabled="!user.homepageUrl"
            @click="checkConnection(user.homepageUrl)"
            v-text="'接続確認'"
          />
        </v-row>
        <v-row class="py-5 mx-1">
          ...
          <v-btn
            ...
            large
            class="ml-2 msy-color-red msy-color-text-white"
            :disabled="!user.blogUrl"
            @click="checkConnection(user.blogUrl)"
            v-text="'接続確認'"
          />
        </v-row>
        <v-row class="py-5 mx-1">
          ...
          <v-btn
            ...
            large
            class="ml-2 msy-color-red msy-color-text-white"
            :disabled="!user.facebookUrl"
            @click="checkConnection(`https://facebook.com/${user.facebookUrl}`)"
            v-text="'接続確認'"
          />
        </v-row>
        <v-row class="py-5 mx-1">
          ...
          <v-btn
            ...
            @click="checkConnection(`https://twitter.com/${user.twitterUrl}`)"
            v-text="'接続確認'"
          />
        </v-row>
      </v-form>
...
export default {
  ...
  methods: {
    ...
    async saveProfile() {
      ...
      if (this.imageObject.imageId !== undefined) {
